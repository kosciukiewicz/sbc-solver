import { DataProvider, appConfig } from "../config";
import club_players from "../assets/mockData/club_players.json";
import sbc_problem from "../assets/mockData/challenges/17.json";
import {
  ClubPlayerCard,
  ClubPlayers,
  RawClubPlayerCard,
...
export const initializeWebAppDataListeners = (
  ...
  init().then(() => {
    if (appConfig.dataProvider == DataProvider.Mock) {
